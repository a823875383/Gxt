...
/**
 * 自定义对话框
 * Created by Joseph ID on 2015/8/20.
 */
public class AlertView {
    ...
    public AlertView builder() {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
                (int) (display.getWidth() * 0.8), FrameLayout.LayoutParams.WRAP_CONTENT);
    ...
    private void setLayout() {
        ...
        if (!showPosBtn && !showNegBtn) {
            ...
            btn_pos.setBackgroundResource(R.drawable.alertview_single_selector);
            btn_pos.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    dialog.dismiss();
        ...
        if (showPosBtn && showNegBtn) {
            btn_pos.setVisibility(View.VISIBLE);
            btn_pos.setBackgroundResource(R.drawable.alertview_right_selector);
            btn_neg.setVisibility(View.VISIBLE);
            btn_neg.setBackgroundResource(R.drawable.alertview_left_selector);
        ...
        if (!showPosBtn && showNegBtn) {
            btn_neg.setVisibility(View.VISIBLE);
            btn_neg.setBackgroundResource(R.drawable.alertview_single_selector);
        }
    }
